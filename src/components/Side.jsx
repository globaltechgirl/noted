        ...
        <div className = "side">
            ...
            <div className="side-body">
                <ul>
                    ...
                    <li onClick={() => handleClick("media")} className={activeSection === "media" ? "active" : ""}>
                        <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                        ...
                        {activeSection === "media" && <svg xmlns="http://www.w3.org/2000/svg" className="side-active-arrow" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v14m6-8l-6-6m-6 6l6-6"/></svg>}
                    </li>

                    <li onClick={() => handleClick("links")} className={activeSection === "links" ? "active" : ""}>
                        <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                        ...
                        {activeSection === "links" && <i class="fa-solid fa-arrow-up side-active-arrow"></i>}
                    </li>
